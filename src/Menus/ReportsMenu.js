...
export const training_one = [
    ...
    { to: '/Home/TrainerTrainingCount', name: 'Trainer Training Report', slno: 266 },
    { to: '/Home/InductRetestEmpDetailsReport', name: 'Induction Retest Employee Reports', slno: 268 },
    { to: '/Home/InductionTrainingTopicWise', name: 'Induction Training TopicWise Report', slno: 30 },
]
export const tarning_two = [
    ...
    { to: '/Home/StaffAttendedMainpage', name: 'Induction Training Attended Staff Report', slno: 243 },
