export const py_setting_one = [
    { to: '/Home/DepartmentMaster', name: 'Department Name', slno: 75 },
    { to: '/Home/DeptSection', name: 'Department Section', slno: 76 },
    { to: '/Home/EmployeeType', name: 'Employee Type', slno: 77 },
    { to: '/Home/DesignationType', name: 'Designation Type', slno: 78 },
    { to: '/Home/Designation', name: 'Designation', slno: 79 },
    { to: '/Home/Qualification', name: 'Qualification', slno: 80 },
    { to: '/Home/District', name: 'District', slno: 81 },
    ...
    { to: '/Home/TrainingTopic', name: 'Training Topic Master', slno: 250 },
    { to: '/Home/TrainingSchedule', name: 'Training Schedule Master', slno: 253 },


]

export const py_setting_two = [
    { to: '/Home/University', name: 'University', slno: 85 },
    { to: '/Home/Specialization', name: 'Specialization', slno: 86 },
    { to: '/Home/EmpDesignationType', name: 'Employee Institution Type', slno: 87 },
    { to: '/Home/Branch', name: 'Branch Master', slno: 88 },
    { to: '/Home/Bank', name: 'Bank', slno: 89 },
    { to: '/Home/Region', name: 'Region', slno: 90 },
    { to: '/Home/DoctorType', name: 'Doctor Type', slno: 91 },
    ...
    { to: '/Home/TrainingQuestions', name: 'Training Questions Master', slno: 251 },
]

export const py_setting_three = [
    { to: '/Home/EmploymentType', name: 'Employee Category', slno: 95 },
    ...
    { to: '/Home/State', name: 'State', slno: 100 },
