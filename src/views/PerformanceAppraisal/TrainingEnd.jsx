...
import { TrainingExcel } from '../Payroll/AttendanceUpdation/ExportToExcel';
    ...
    const toDownload = async () => {
        ...
        const array = tableData.map((val) => {
            return {
                ...
                "TrainingEndDate": val.training_end
            }
        })
        TrainingExcel(array, fileName)
    }
