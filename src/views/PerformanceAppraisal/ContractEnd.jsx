...
import ContractEndTable from './ContractEndTable';
...
const ContractEnd = () => {
    ...
    useEffect(() => {
        const contractEndList = async () => {
            const result = await axioslogin.get('/Performance/contractdata')
    ...
    return (
        <Fragment>
            ...
            >
                ...
                {
                    pb === true ? <ContractEndTable tableData={tableData} /> : null
                }
            </PageLayoutCloseOnly>
        </Fragment >
    )
