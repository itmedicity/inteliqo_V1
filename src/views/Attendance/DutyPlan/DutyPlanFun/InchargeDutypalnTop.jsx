...
const InchargeDutypalnTop = () => {
    ...
    const { fromDate, toDate, } = planState
    ...
    const { hod, incharge, em_id, em_department, sect_name, em_dept_section } = employeeProfileDetl;
    ...
    const onClickDutyPlanButton = useCallback(async (e) => {
        ...
        if (em_department === 0 || em_dept_section === 0) {
            ...
            const formData = {
                ...
                deptName: em_department,
                deptSecName: em_dept_section
            }
                ...
                if (lastUpdateDate === lastDay_month) {
                    ...
                    getEmployeeDetlDutyPlanBased(postData).then((emplyDataArray) => {
                        ...
                        if (status === 1) {
                            ...
                            //process function
                            dutyPlanInsertFun(formData, commonSettings, holidayList, data, deptShift).then((values) => {
...
export default memo(InchargeDutypalnTop) 