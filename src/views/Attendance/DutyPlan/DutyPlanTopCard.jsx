                ...
                <Box
                    ...
                    <LocalizationProvider dateAdapter={AdapterMoment} >
                        <DatePicker
                            ...
                            value={fromDate}
                            onChange={(date) => dispatch({ type: FROM_DATE, from: moment(date).format('YYYY-MM-DD') })}
                            renderInput={
                                (params) => <TextField {...params} helperText={null} size='small' sx={{ display: 'flex' }} />
                            }
                        />
                ...
                >
                    <LocalizationProvider dateAdapter={AdapterMoment} >
                        <DatePicker
                            ...
                            inputFormat="DD-MM-YYYY"
                            value={toDate}
                            onChange={(date) => dispatch({ type: TO_DATE, to: moment(date).format('YYYY-MM-DD') })}
                            renderInput={
                                (params) => <TextField {...params} helperText={null} size='small' sx={{ display: 'flex' }} />
                            }
                        />
