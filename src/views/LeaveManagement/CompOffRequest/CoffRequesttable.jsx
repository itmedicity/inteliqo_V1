...
import { getCommonSettings, getEmployeeCoffData, getEmployeeInformationLimited, getInchargeHodData } from 'src/redux/reduxFun/reduxHelperFun';
...
const CoffRequesttable = () => {
    ...
    const { hod, incharge, groupmenu, em_id, } = employeeInform;
