...
const CredentialOperating = ({ FormDatamain, setFormDatamain, Credentialdata }) => {
    ...
    const { CpName, CpRemark, Cpdatesaved } = FormDatamain
    return (
        <Box sx={{ mt: 2 }}>
                ...
                <Table sx={{ mt: 1, p: 0, width: '100%' }} aria-label="basic table" borderAxis="both" size='sm' variant="outlined">
                    <tbody >
                        <tr sx={{ p: 0 }}>
                            ...
                            <td padding='none'  >
                                <Typography sx={{ ml: 1, }}>{Credentialdata?.Hod_Other_approvalDate}</Typography>
                ...
                <Table sx={{ mt: 1, p: 0, width: '100%' }} aria-label="basic table" borderAxis="both" size='sm' variant="outlined">
                    <tbody >
                        <tr sx={{ p: 0 }}>
                            ...
                            <td padding='none'  >
                                <Typography sx={{ ml: 1, }}>{Credentialdata?.MS_Other_approvalDate}</Typography>
                ...
                <Table sx={{ mt: 1, p: 0, width: '100%' }} aria-label="basic table" borderAxis="both" size='sm' variant="outlined">
                    <tbody >
                        <tr sx={{ p: 0 }}>
                            ...
                            <td padding='none'  >
                                <Typography sx={{ ml: 1, }}> {CpName} </Typography>
                            </td>
                            <td padding='none'  >
                                <Typography sx={{ ml: 1, }}>Signature</Typography>
                            </td>
