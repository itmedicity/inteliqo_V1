...
const CredentialDocmodal = ({ isModalOpen, setIsModalOpen, Empdata, count, SetCount }) => {
    ...
    const handleOnClick = useCallback(async (event) => {
        ...
        if (MdRemark === '') {
            ...
            const result = await axioslogin.post('/PersonalChecklist/CredentialDocMDApproval', personaldata)
...
export default memo(CredentialDocmodal)