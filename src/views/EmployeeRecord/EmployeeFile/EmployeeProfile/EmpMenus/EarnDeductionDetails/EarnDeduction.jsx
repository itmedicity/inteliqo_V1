    ...
    return (
        <Fragment>
            ...
            <Box sx={{ width: "100%", height: { xxl: 825, xl: 680, lg: 523, md: 270, sm: 270, xs: 270 }, overflow: 'auto', '::-webkit-scrollbar': { display: "none" } }} >
                <Paper elevation={0} square sx={{ display: "flex", height: 30, flexDirection: 'column' }}>
                    <Box sx={{ display: "flex", flex: 1, height: 30, }} >
                        <Paper elevation={0} variant='outlined' square sx={{ display: "flex", flex: 1, height: 30, alignItems: 'center', justifyContent: "space-between" }} >
                            <Box sx={{ display: "flex" }}>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", flex: 1, px: 0.5 }}>
                    <Box sx={{ display: "flex", flexDirection: "row", px: 20, width: '100%', pt: 1 }}>
                        ...
                        <Box sx={{ display: 'flex', width: '30%', }} >
                            <JoyWageSelect wagevalue={wage} setWage={setWage} />
                        </Box>
