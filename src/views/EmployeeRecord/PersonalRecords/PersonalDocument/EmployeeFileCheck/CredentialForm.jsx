...
const CredentialForm = ({ Empdata, itemname, setformid }) => {
    ...
    const { email, em_name, dob, mobile_num, reg_name, relg_name, addressPermnt1, addressPermnt2, edu, hrm_pin1 } = details;
    useEffect(() => {
