...
const Record = ({ setShowGeneral, Files }) => {
                                ...
                                <TableBody >
                                    <TableRow sx={{ p: 0 }}>
                                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: "50%" }}>
                                            <Typography level="title-md" sx={{ ml: 1 }}> Section </Typography>
                                        </TableCell>
                                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: "50%" }}>
                            ...
                            <Table sx={{ mt: 1, p: 0, border: '1px solid #e0e0e0', width: '100%' }}>
                                <TableBody >
                                    <TableRow sx={{ p: 0 }}>
                                        ...
                                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                            <Typography level="title-md" sx={{ ml: 1 }}>Record Name</Typography>
                                        </TableCell>
                                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                            <Typography level="title-md" sx={{ ml: 1 }}>Date of entry</Typography>
                                        </TableCell>
                                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                            <Typography level="title-md" sx={{ ml: 1 }}>Hr Name</Typography>
                                        </TableCell>
                                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                            <Typography level="title-md" sx={{ ml: 1 }}>Sign</Typography>
                                        </TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
