    ...
    return (
        <>
                ...
                <TableBody>
                    <TableRow sx={{ p: 0 }}>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '15%' }}>
                            <Typography level="title-md" sx={{ ml: 1, }}>Notice Period </Typography>
                        </TableCell>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '16%' }}>
                            <Typography level="title-md" sx={{ ml: 1, textAlign: 'center' }}>Applicable</Typography>
                        </TableCell>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '16%' }}>
                        ...
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '16%' }}>
                            <Typography level="title-md" sx={{ ml: 1, textAlign: 'center' }}>Not Applicable </Typography>
                        </TableCell>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '16%' }}>
                    ...
                    <TableRow sx={{ p: 0 }}>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '5%' }}>
                            <Typography level="title-md" sx={{ ml: 1, }}> ID Card Received </Typography>
                        </TableCell>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '16%' }}>
                            <Typography level="title-md" sx={{ ml: 1, textAlign: 'center' }}>Yes</Typography>
                        </TableCell>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '16%' }}>
                        ...
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '16%' }}>
                            <Typography level="title-md" sx={{ ml: 1, textAlign: 'center' }}>No </Typography>
                        </TableCell>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '16%' }}>
                            <Typography level="title-md" sx={{ ml: 1, pt: 1, textAlign: 'center' }}>
                                <JoyCheckbox
                                    sx={{}}
                                    name="workstation"
                                // checked={workstation}
                    ...
                    <TableRow sx={{ p: 0 }}>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '5%' }}>
                            <Typography level="title-md" sx={{ ml: 1, }}>Exit Interview Completed </Typography>
                        </TableCell>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '16%' }}>
                            <Typography level="title-md" sx={{ ml: 1, textAlign: 'center' }}>Yes</Typography>
                        </TableCell>
                    ...
                    <TableRow sx={{ p: 0 }}>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '5%' }}>
                            <Typography level="title-md" sx={{ ml: 1, }}>Experience Certificate issued </Typography>
                        </TableCell>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '16%' }}>
                            <Typography level="title-md" sx={{ ml: 1, textAlign: 'center' }}>Yes</Typography>
                        </TableCell>
            ...
            <Box sx={{ mt: 1 }}>
                ...
                <Box sx={{ display: "flex" }}>
                    <Typography level="title-md">Forwarded to Accounts Department</Typography>
                    <Box sx={{ ml: 1 }}>
                        <JoyCheckbox
                            sx={{}}
                            name="workstation"
                ...
                <TableBody>
                    <TableRow>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '20%' }}>
                            <Typography level="title-md" sx={{ ml: 1 }}>Forwarded By Name </Typography>
                        </TableCell>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '20%' }}>
