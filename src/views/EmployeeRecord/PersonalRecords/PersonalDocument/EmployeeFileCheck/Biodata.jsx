...
const Bioedu = lazy(() => import('./Bioedu'))
const Bioexp = lazy(() => import('./Bioexp'))

const Biodata = ({ Empdata, itemname, setformid }) => {
    ...
    const { email, em_name, dob, mobile_num, reg_name, relg_name, addressPermnt1, addressPermnt2, } = details;
    useEffect(() => {
        if (Empdata && Empdata.length > 0) {
            const { em_name, em_dob, em_mobile, reg_name, relg_name, em_email, addressPermnt1, addressPermnt2 } = Empdata[0]
    ...
    return (
        <Box>
            ...
            <Box sx={{ height: window.innerHeight - 200, overflowX: "auto", '::-webkit-scrollbar': { display: "none" }, mt: 1 }}>
