                ...
                <Table sx={{ mt: 1, p: 0, border: '1px solid #e0e0e0', width: '100%' }} >
                    ...
                    <TableBody >
                        <TableRow sx={{ p: 0 }}>
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: "50%" }}>
                                <Typography sx={{ ml: 1, textTransform: 'capitalize' }}>
                                    {/* {val?.Employer === "" ? "not updated" : val?.Employer} */}
                                </Typography>
                        ...
                        <TableRow sx={{ p: 0 }}>
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1, textTransform: 'capitalize' }}>
                                    {/* {val?.jobexp === "" ? "not updated" : val?.jobexp} */}
                                </Typography>
                        ...
                        <TableRow sx={{ p: 0 }}>
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1 }}>
                                    {/* {val?.expstartdate === 0 ? "not updated" : moment(val?.expstartdate).format('DD-MM-YYYY')} */}
                                </Typography>
                            </TableCell>
                        </TableRow>
                        <TableRow sx={{ p: 0 }}>
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', }}>
                                <Typography sx={{ ml: 1 }}>
                                    {/* {val?.expenddate === 0 ? "not updated" : moment(val?.expenddate).format('DD-MM-YYYY')} */}
                                </Typography>
                            </TableCell>
                        </TableRow>
                        <TableRow sx={{ p: 0 }}>
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1 }}>
                                    {/* {val?.Workingstatus === false ? "No" : val?.Workingstatus === true ? "Yes" : "not updated"} */}
                                </Typography>
                        ...
                        <TableRow sx={{ p: 0 }}>
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1, textTransform: 'capitalize' }}>
                                    {/* {val?.SupervisorName === "" ? "not updated" : val?.SupervisorName} */}
                                </Typography>
                        ...
                        <TableRow sx={{ p: 0 }}>
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1, textTransform: 'capitalize' }}>
                                    {/* {val?.Additionalinf === "" ? "not updated" : val?.Additionalinf} */}
                                </Typography>
                        ...
                        <TableRow sx={{ p: 0 }}>
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1, textTransform: 'capitalize' }}>
                                    {/* {val?.Other === "" ? "not updated" : val?.Other} */}
                                </Typography>
                        ...
                        <TableRow sx={{ p: 0 }}>
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1, textTransform: 'capitalize' }}>
                                    {/* {val?.Responsibilities === "" ? "not updated" : val?.Responsibilities} */}
                                </Typography>
