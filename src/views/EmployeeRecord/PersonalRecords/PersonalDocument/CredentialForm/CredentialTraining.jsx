    ...
    return (
        <Box>
                ...
                <TableBody >
                    <TableRow sx={{ p: 0 }}>
                        <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '5%' }} >
                            <Typography sx={{ ml: 1, textAlign: 'center' }}>Sl No </Typography>
                        </TableCell>
            ...
            <Box>
                ...
                <Typography sx={{ ml: 1, }}> I declare that I am in sound physical and mental health .I do not have any medical legal or other suit against me before
