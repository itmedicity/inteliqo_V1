...
const CredentialParaRegistration = ({ Employee, ExpData, setExpData, CertificateData, setCertificateData, setVerificationdata, ApprovalData,
    FormDatamain, setFormDatamain, Verificationdata, setHrdNo, HrdNo, Operating, setOperating, Training, Credentialcert, privilageData }) => {
        ...
        <Box sx={{ mt: 1 }}>
            ...
            <TableContainer sx={{ mt: 1 }}>
                ...
                <CredentialTraining ExpData={ExpData} setExpData={setExpData} Employee={Employee} CertificateData={CertificateData} FormDatamain={FormDatamain} setFormDatamain={setFormDatamain}
                    ...
                    HrdNo={HrdNo} setHrdNo={setHrdNo} Operating={Operating} setOperating={setOperating} Training={Training} Credentialcert={Credentialcert} privilageData={privilageData} />
            </TableContainer>
...
export default memo(CredentialParaRegistration)