...
const CredentialTraining = ({ ExpData, setExpData, Employee, CertificateData, setCertificateData, setVerificationdata, ApprovalData,
    Verificationdata, setHrdNo, HrdNo, FormDatamain, setFormDatamain, Operating, setOperating, List, setList, Training, Credentialcert }) => {
    ...
    return (
        <Box>
            ...
            <CredentialPrivileging Employee={Employee} FormDatamain={FormDatamain} setFormDatamain={setFormDatamain} Operating={Operating}
                setOperating={setOperating} List={List} setList={setList} ApprovalData={ApprovalData} />
        </Box >
    )
}
