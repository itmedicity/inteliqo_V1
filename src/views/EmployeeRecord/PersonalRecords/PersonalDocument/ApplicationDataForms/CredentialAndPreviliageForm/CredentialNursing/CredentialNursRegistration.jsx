...
const CredentialNursRegistration = ({ Employee, ExpData, setExpData, CertificateData, setCertificateData, setVerificationdata, ApprovalData,
    FormDatamain, setFormDatamain, Verificationdata, setHrdNo, HrdNo, Operating, setOperating, List, setList, Training, Credentialcert }) => {
        ...
        <Box sx={{ mt: 1 }}>
            ...
            <TableContainer sx={{ mt: 1 }}>
                ...
                <CredentialTraining ExpData={ExpData} setExpData={setExpData} Employee={Employee} CertificateData={CertificateData} FormDatamain={FormDatamain} setFormDatamain={setFormDatamain}
                    ...
                    HrdNo={HrdNo} setHrdNo={setHrdNo} Operating={Operating} setOperating={setOperating} List={List} setList={setList} Training={Training} Credentialcert={Credentialcert} />
            </TableContainer>
...
export default memo(CredentialNursRegistration) 