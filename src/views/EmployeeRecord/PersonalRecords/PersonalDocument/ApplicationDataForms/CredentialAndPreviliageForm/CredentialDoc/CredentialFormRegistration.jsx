...
const CredentialFormRegistration = ({ Employee, ExpData, setExpData, CertificateData, setCertificateData, setVerificationdata,
    FormDatamain, setFormDatamain, Verificationdata, setHrdNo, HrdNo, Operating, setOperating, Training, Credentialcert, privilageData, ApprovalData }) => {
        ...
        <Box sx={{ mt: 1 }}>
            ...
            <TableContainer sx={{ mt: 1 }}>
                ...
                <CredentialTraining ExpData={ExpData} setExpData={setExpData} Employee={Employee} CertificateData={CertificateData} FormDatamain={FormDatamain} setFormDatamain={setFormDatamain}
                    setCertificateData={setCertificateData} Verificationdata={Verificationdata} setVerificationdata={setVerificationdata} privilageData={privilageData}
                    HrdNo={HrdNo} setHrdNo={setHrdNo} Operating={Operating} setOperating={setOperating} Training={Training} Credentialcert={Credentialcert} ApprovalData={ApprovalData} />
            </TableContainer>
