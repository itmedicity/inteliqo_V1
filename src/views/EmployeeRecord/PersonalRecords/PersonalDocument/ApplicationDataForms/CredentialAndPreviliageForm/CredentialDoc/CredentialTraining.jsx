...
const CredentialTraining = ({ ExpData, setExpData, Employee, CertificateData, setCertificateData, setVerificationdata, ApprovalData,
    ...
    return (
        <Box>
            ...
            <CredentialPrivileging Employee={Employee} FormDatamain={FormDatamain} privilageData={privilageData} ApprovalData={ApprovalData}
                setFormDatamain={setFormDatamain} Operating={Operating} setOperating={setOperating} />
        </Box >
    )
}
