...
const CredentialTraining = ({ ExpData, setExpData, Employee, CertificateData, setCertificateData, setVerificationdata, ApprovalData,
    Verificationdata, setHrdNo, HrdNo, FormDatamain, setFormDatamain, Operating, setOperating, Credentialcert, privilageData, Training }) => {
    ...
    return (
        <Box>
            ...
            <CredentialPrivileging Employee={Employee} privilageData={privilageData} FormDatamain={FormDatamain}
                setFormDatamain={setFormDatamain} Operating={Operating} setOperating={setOperating} ApprovalData={ApprovalData} />
        </Box >
    )
}
