...
const AppointmentLetter = ({ Empdata }) => {
    return (
        <Box sx={{
            mt: 1,
            p: 2,
            ...
            <Box sx={{ display: "flex", justifyContent: 'space-between' }}>
                ...
                <Typography sx={{}}>DATE :  {moment(Empdata?.em_doj).format('DD-MM-YYYY')}</Typography>
            </Box>
            ...
            <Box sx={{ mt: 3 }}>
                <Typography level="title-md" >We are pleased to engage you as {Empdata?.desg_name === '' ? "Not Updated" : Empdata?.desg_name} in this establishment on the following terms and condition for a fixed of One year ,
                    commencing from {moment(Empdata?.em_doj).format('DD-MM-YYYY')}</Typography>
            </Box>
            <Box sx={{ mt: 3, ml: 2 }}>
            ...
            <Box sx={{ mt: 3, ml: 2 }}>
                <Typography level="title-md" >31. The period of this order and engagement will automatically expire on {moment(Empdata?.em_contract_end_date).format('DD-MM-YYYY')} You will not be entitled for any further notice or
            ...
            <Box sx={{ mt: 3 }}>
                <Typography level="title-md" >Signature : General Manager HR</Typography>
            </Box>
            <Box sx={{ mt: 3 }}>
                <Typography level="title-md" >Date :{moment(Empdata?.em_doj).format('DD-MM-YYYY')}  </Typography>
            </Box>
        </Box>
    )
}

export default memo(AppointmentLetter)