        ...
        <Box sx={{ height: window.innerHeight - 170, overflowX: "auto", '::-webkit-scrollbar': { display: "none" }, p: 1 }}>
            <TableContainer sx={{}}>
                ...
                <Box sx={{ mt: 1 }}>
                    ...
                    <Typography level="title-md" sx={{ ml: 1, mt: 1 }}>Comments by Unit Incharge/Supervisor/Head of the Department</Typography>
                    <Typography sx={{ ml: 1, mt: 1 }}>He/She handed over change to Mr/ms _________ and there is nothing outstanding /the following are outstanding against him/her.</Typography>
                </Box>
                <Table sx={{ mt: 1, p: 0, border: '1px solid #e0e0e0', width: '100%' }}>
                    <TableBody >
                        <TableRow sx={{ p: 0 }}>
...
export default memo(DueClearance)