      ...
      <div className="card">
        ...
        <form className={classes.empRecordStyle} onSubmit={submitemployeerecord}>
              ...
              <div className="col-md-12">
                ...
                <div className="col-md-12 p-1">
                  <div className="row">
                    ...
                    <div
                      className="col-md-4"
                      data-tip="Permanent-Street Name"
                      data-for="toolTip1"
                      data-place="top"
                    >
                      <ReactTooltip id="toolTip1" />
                  ...
                  <div className="card-body">
                    <div className="col-md-12">
                      ...
                      <div className="row">
                        ...
                        <TextField name="cont_period" value={cont_perioddate} hidden />
                        <TextField name="cont_grace" value={cont_gracedate} hidden />
                        <TextField name="desiggperiod" value={probationendate} hidden />
                        <TextField name="retirementdate" value={retirementyear} hidden />
                      </div>
                      <div className="row">
                        <div
                          className="col-md-2"
          ...
          <div className="card-footer">
            <FooterClosebtn redirect={toSettings} view={toTable} />
          </div>
        </form>
      </div>
    </Fragment>
