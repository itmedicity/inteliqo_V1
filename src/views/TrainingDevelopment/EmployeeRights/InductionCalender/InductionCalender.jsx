    ...
    return (
        < Fragment >
            <Box sx={{
                ...
                <Box sx={{ mt: 2, width: "100%", height: 400, display: "flex", justifyContent: "center" }}>
                    ...
                    <Box>
                        <Box sx={{ width: "100%", textAlign: "center", px: 10 }}>
                            <Box sx={{ border: 1, backgroundColor: "#176B87", borderColor: "#D8D9DA", textAlign: "center", display: "flex", flexDirection: "row", }}>
                                <Box sx={{ color: "white", width: "40%", p: 1.5, borderRight: 1, borderColor: "#D8D9DA" }}><h6>MONTH</h6></Box>
                            ...
                            <Box sx={{
                                overflow: 'auto',
                                '::-webkit-scrollbar': { display: "none" }, height: 350
                            }}>
                                {
                                    months?.map((month, index) => (
                                        <Box key={index}>
                                            <Box sx={{ display: "flex", flexDirection: "row" }}>
                                                <Box sx={{
                                                    width: "40%", borderBottom: 1, borderLeft: 1,
