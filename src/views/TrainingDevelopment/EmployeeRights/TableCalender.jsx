...
import TrainingonMonthModal from '../DepartmentalTraining/TrainingonMonthModal';
import TableRows from './TableRows';

const TableCalender = ({ checkdata, year, setYear, count, Setcount, dept, setdept, deptSec,
    ...
    return (
        < Fragment >
            <Box sx={{ width: "100%", p: 1, }}>
                ...
                <Box sx={{ mt: 2, width: "100%", height: 350, display: "flex", justifyContent: "center" }}>
                    <Box sx={{ width: "100%", textAlign: "center", px: 10 }}>
                        <Box sx={{ border: 1, backgroundColor: "#176B87", borderColor: "#D8D9DA", textAlign: "center", display: "flex", flexDirection: "row", }}>
...
export default memo(TableCalender) 
