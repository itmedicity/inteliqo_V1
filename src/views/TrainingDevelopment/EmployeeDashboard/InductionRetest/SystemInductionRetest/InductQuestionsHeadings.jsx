...
import InductFileOptions from './InductFileOptions';

const InductQuestionsHeadings = ({ incmentCount, setincmentCount, data, order, clrFlagA, SetclrFlagA, clrFlagB, SetclrFlagB, clrFlagC, SetclrFlagC, clrFlagD, SetclrFlagD, setRightAns, setDisright }) => {
        ...
        <Fragment>
...

            {
                filestatus === 0 ?
                    ...
                    : <InductFileOptions clrFlagA={clrFlagA} clrFlagB={clrFlagB} clrFlagC={clrFlagC} clrFlagD={clrFlagD}
...
export default memo(InductQuestionsHeadings)
