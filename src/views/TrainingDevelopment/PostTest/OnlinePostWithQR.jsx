...
import { PostTestEmpDetails, QuestionList } from 'src/redux/actions/Training.Action';
import { useDispatch, useSelector } from 'react-redux';
import _ from 'underscore';
import { axioslogin } from 'src/views/Axios/Axios';
import { warningNofity } from 'src/views/CommonCode/Commonfunc';
import { useParams } from 'react-router-dom/cjs/react-router-dom.min';
import QRQuestionHeading from './QRQuestionHeading';
import QRShowModal from './QRShowModal';

const OnlinePostWithQR = () => {
    ...
    useEffect(() => {
        if (qcount !== 0) {
            ...
            dispatch(PostTestEmpDetails(id))
        }
    ...
    const Emp_Details = useSelector((state) => state?.gettrainingData?.PostEmpDetails?.PostEmpDetailsList, _.isEqual)
...
export default memo(OnlinePostWithQR)
