...
import { MonthWiseDeptSchedules } from 'src/redux/actions/Training.Action';
import moment from 'moment/moment';
import DeptScheduleModal from './DeptScheduleModal';
import { DeptRedux } from '../InductRedux';
import ViewScheduledModal from './ViewScheduledModal';
import { axioslogin } from 'src/views/Axios/Axios';

const DeptCalendarLayout = ({ count, SetCount, setTable, dept, deptSec, year, EmpDetails }) => {
    ...
    return (
        <Fragment>
            ...
            {View === true ? <DeptScheduleModal Scheduledata={Scheduledata} setTable={setTable} EmpDetails={EmpDetails} SetView={SetView} View={View} datefrmt={datefrmt} SetDatefrmt={SetDatefrmt} count={count} SetCount={SetCount} dept={dept} deptSec={deptSec} year={year} topic={topic} setTopic={setTopic} /> : null}
...
export default memo(DeptCalendarLayout) 
