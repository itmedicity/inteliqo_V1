...
const BlowAverageDeptEmpList = ({ BelowAvgList, setShow, count, Setcount }) => {
    ...
    return (
        <Paper>
            <CustomDashboardPage title="Departmental Below Average Employees" displayClose={true} setClose={setShow} >
...
export default memo(BlowAverageDeptEmpList) 
