...
const ViewFileQROptions = ({ Questn, clrFlagA, SetclrFlagA, clrFlagB, SetclrFlagB, clrFlagC, SetclrFlagC, clrFlagD, SetclrFlagD, setDisright, incmentCount, setincmentCount, disQuestn, setDisQuestn }) => {
...
export default memo(ViewFileQROptions)
