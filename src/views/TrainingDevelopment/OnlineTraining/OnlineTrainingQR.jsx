...
import VideoPlayerPageQR from './VideoPlayerPageQR';
import PdfViewerQR from './PdfViewerQR';

const OnlineTrainingQR = () => {
    ...
    useEffect(() => {
        dispatch(OnlineTrainingTopicListOfEmp(emId))
        Setcount(0);
    }, [dispatch, emId, count])
...
export default memo(OnlineTrainingQR)
