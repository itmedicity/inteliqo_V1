...
const TrainingOverviewPage = ({ inductComplt, inductPndg, inductNext, InductRetest, InductTotal }) => {

    return (
        <Fragment>
            <Paper sx={{ flex: 1, height: 300, boxShadow: 4, p: 1, backgroundColor: "#FFFFFF" }}>
...
export default memo(TrainingOverviewPage)
