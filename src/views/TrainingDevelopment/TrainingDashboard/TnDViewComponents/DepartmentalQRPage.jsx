...
import { DashboardTrainingPreTopics } from 'src/redux/actions/Training.Action';
import PreQRmodal from '../../CommonPreTest/PreQRmodal';

const DepartmentalQRPage = () => {
    ...
    useEffect(() => {
        dispatch(DashboardTrainingPreTopics())
        Setcount(0);
    }, [dispatch, count])

    //login employee topics
    const PrePostTopics = useSelector((state) => state?.gettrainingData?.DashboardPreTopics?.DashboardPreTopicsList, _.isEqual)
...
export default memo(DepartmentalQRPage) 
