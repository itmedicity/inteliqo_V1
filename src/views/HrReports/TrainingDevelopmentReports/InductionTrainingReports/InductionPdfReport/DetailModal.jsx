...
import InductTraineerDetail from 'src/views/TrainingDevelopment/TrainingDetails/InductTraineerDetail';
import TraineerDetail from 'src/views/TrainingDevelopment/TrainingDetails/TraineerDetail';
import { format } from 'date-fns';

const DetailModal = ({ selectedData, SetOpen, open }) => {
    ...
    useEffect(() => {
        if (selectedData?.length !== 0) {
            const viewData = selectedData?.find((val) => val.em_id !== 0)
    ...
    useEffect(() => {
        const Induct = InductionData?.map((val) => {
            const object = {
                ...
                induction_date: format(new Date(val.induction_date), 'dd-MM-yyyy'),
    ...
    useEffect(() => {
        const deptdata = DepartData?.map((val) => {
            const object = {
                ...
                schedule_date: format(new Date(val.schedule_date), 'dd-MM-yyyy'),
                allowPrepost: val.posttest_status === 1 ? "Yes" : "No",
                Re_test: val.retest === 1 ? "Yes" : "No",
                ...
                {InductionData?.length !== 0 ? (
                    <Sheet
                        sx={{
                            ...
                            maxWidth: '100%',      // Optional: Set a max width to control horizontal scrolling
                            height: '200px',         // Set the height for vertical scrolling
                    ...
                    >
                        <Table stickyHeader>
                            <thead>
                                <tr>
                                    <th style={{ width: "5%", position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Slno</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Date</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Topic</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Trainers</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Online Mode</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Offline Mode</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Pre-Post Status</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Pre-Test Mark</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Post-Test Mark</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Retest</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Retest Mark</th>
                                    <th style={{ position: 'sticky', top: 0, backgroundColor: '#fff', zIndex: 1 }}>Eligible/Not</th>
                                </tr>
                            </thead>
                            <tbody>
