...
import { endOfMonth, format, isValid, startOfYear } from 'date-fns'
import { warningNofity } from 'src/views/CommonCode/Commonfunc'
import { axioslogin } from 'src/views/Axios/Axios'

const CreditedLeaveCountReport = () => {
    ...
    return (
        <ReportLayout title="Credited Leave Count Report" displayClose={true} data={tableData} >
...
export default memo(CreditedLeaveCountReport) 