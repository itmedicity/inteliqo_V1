...
const ExperienceSummaryReport = () => {
    ...
    const getEmployeeExperience = useCallback((e) => {
        ...
        const getEmployeeDepartment = async (slno) => {
            const result = await axioslogin.post('/experienceReport/exp/summary', slno)
        ...
        const getEmpDeptSect = async (postData) => {
            const result = await axioslogin.post('/experienceReport/exp/deptsect', postData)
            const { success, data } = result.data;
            if (success === 1) {
                setTableData(data)
            }
        ...
        const getEmployee = async (postDataemp) => {
            const result = await axioslogin.post('/experienceReport/exp/empname', postDataemp)
...
export default memo(ExperienceSummaryReport) 