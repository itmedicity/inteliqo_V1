...
const Interviewexp = lazy(() => import('./Interviewexp'))
const Interviewedu = lazy(() => import('./Interviewedu'))

const InterviewModal = ({ setIsModalOpen, isModalOpen, personaldata }) => {
    ...
    useEffect(() => {
        if (personaldata && personaldata.length > 0) {
            const { first_name, last_name, dob, mobile_num, reg_name, relg_name, email, } = personaldata[0]
