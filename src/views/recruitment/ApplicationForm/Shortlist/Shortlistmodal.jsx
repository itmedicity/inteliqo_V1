...
const Shortlistedu = lazy(() => import('./Shortlistedu'))
const Shortlistexp = lazy(() => import('./Shortlistexp'))
const Shortlistmodal = ({ isModalOpen, setIsModalOpen, personaldata }) => {
    ...
    const { email, first_name, last_name, dob, mobile_num, reg_name, relg_name } = details;
            ...
            <Modal open={isModalOpen} onClose={() => setIsModalOpen(false)}>
                ...
                ><ModalClose
                    ...
                    <Box sx={{ height: window.innerHeight - 200, overflowX: "auto", '::-webkit-scrollbar': { display: "none" } }}>
                        ...
                        <Box sx={{ mt: 2 }}>
                            <Shortlistexp details={details} />
                        </Box>
                        <Box sx={{ mt: 2 }}>
                            <Shortlistedu details={details} />
                        </Box>
                    </Box>
                </Box>
            </Modal>
...
export default memo(Shortlistmodal)