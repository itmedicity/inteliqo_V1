...
import React, { memo, useEffect, useState, Fragment, useCallback } from 'react'
...
const Ranking = () => {
                            ...
                            const updatedApslno = item.apslno.map((apslnoItem) => {
                                ...
                                return foundStatus ? {
                                    ...
                                    totalmark: (foundStatus.Hr_Interview_Mark + foundStatus.total_Incharge_inter_mark + foundStatus.Hod_interview_mark + foundStatus.Ms_Interview_Mark + foundStatus.Dms_Interview_Mark +
                                        foundStatus.Operation_Interview_Mark + foundStatus.Ceo_Interview_Mark)
                                } : apslnoItem;
                            });
    ...
    return (
        <Box sx={{ display: 'flex', flex: 1, flexDirection: 'column', height: window.innerHeight - 100, overflowX: "auto" }}>
            <DasboardCustomLayout title={"Candidate Ranking"} displayClose={true} setClose={toRedirectToHome}>
                            ...
                            <Table sx={{ p: 0, width: '100%' }}>
                                <TableHead >
                                    <TableRow>
                                        ...
                                        <TableCell colSpan={2}><Typography>Department</Typography></TableCell>
                                        ...
                                        return (
                                            <Fragment key={val.desg_id}>
                                                <TableRow>
                                                    ...
                                                    <TableCell colSpan={2} size='small' >{val.dept_name}</TableCell>
