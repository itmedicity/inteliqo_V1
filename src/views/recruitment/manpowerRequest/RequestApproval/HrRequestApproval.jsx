...
const ModalHr = lazy(() => import('./ModalHr'))
const HrRequestApproval = () => {
                ...
                if (data && data.length > 0) {
                    ...
                    const arr = hodapprove?.map((val) => {
                        const obj = {
                            ...
                            Hr_approval_status: val?.Hr_approval_status,
                            Hr_approval: val?.Hr_approval_status === 1 ? "Approved" : val?.Hr_approval_status === 2 ? "Rejected" : "Pending"
    ...
    const [columnDef] = useState([
        ...
        { headerName: 'last date', field: 'required_date', filter: true },
        {
            headerName: 'Action',
            cellRenderer: (params) => {
                if (params?.data?.Hr_approval_status === 1) {
                    return (
                ...
                } else if (params?.data?.Hr_approval_status === 2) {
                    return (
                        <IconButton sx={{ p: 0.1, cursor: 'none' }}>
        ...
        { headerName: 'Status', field: 'Hr_approval', filter: true },
    ])
    return (
...
export default memo(HrRequestApproval) 