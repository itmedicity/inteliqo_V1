import { Box, Modal, ModalClose, IconButton, Textarea, Typography } from '@mui/joy'
...
const ModalJobDescription = ({ setIsModalOpendesc, isModalOpendesc, em_department, desg }) => {
    ...
    }, [PersonalData, duties, desg, em_department, defaultstate, setCount, slno])
    ...
    return (
        <Box>
            <Modal open={isModalOpendesc} onClose={() => setIsModalOpendesc(false)}>
                <Box
                    sx={{
                        position: 'absolute',
                        top: '50%',
...
export default memo(ModalJobDescription)