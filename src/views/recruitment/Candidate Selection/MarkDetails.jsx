                ...
                <Table sx={{ mt: 1, p: 0, border: '1px solid #e0e0e0', width: '100%' }}>
                    <TableBody>
                        <TableRow sx={{ p: 0 }}>
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0', width: '10%' }}>
                                <Typography textColor="#000000" sx={{ ml: 1 }}>Total Mark </Typography>
                            </TableCell>
                        </TableRow>
                        ...
                        <TableRow sx={{ p: 0 }} >
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1 }}>{data?.totalmark === undefined ? 0 : data?.totalmark} </Typography>
                            </TableCell>
                        </TableRow>
...
export default memo(MarkDetails)