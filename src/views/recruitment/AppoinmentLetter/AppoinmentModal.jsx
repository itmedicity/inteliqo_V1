...
const AppointmentPdfView = lazy(() => import('./AppointmentPdfView'))


const AppoinmentModal = ({ isModalOpen, setIsModalOpen, personaldata, dataitem }) => {
            ...
            <Modal open={isModalOpen} onClose={() => setIsModalOpen(false)}>
                ...
                ><ModalClose
                    ...
                    <Box sx={{ overflowX: "auto", '::-webkit-scrollbar': { display: "none" } }}>
                        ...
                        <Box sx={{ mt: 1 }}>
                            <AppointmentPdfView details={details} desgid={desgid} setIsModalOpen={setIsModalOpen} />
