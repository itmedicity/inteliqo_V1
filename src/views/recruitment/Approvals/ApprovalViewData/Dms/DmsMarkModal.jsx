...
const DmsMarkModal = ({ setOpenRowIndex, setIsModalOpen, data, setcount, count, stausdata }) => {
    ...
    }, [data, totalmark, subjectmark, remark, expmark, edumark, techmark, presentationmark, analyticalmark,
