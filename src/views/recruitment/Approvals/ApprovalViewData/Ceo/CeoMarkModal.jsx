...
const CeoMarkModal = ({ setOpenRowIndex, setIsModalOpen, data, count, setcount, stausdata }) => {
    ...
    }, [data, totalmark, subjectmark, remark, expmark, edumark, techmark, presentationmark, analyticalmark, communicationmark,
    ...
    const submitmanpower = useCallback(async (event) => {
        ...
        const result = await axioslogin.post('/Applicationform/Ceointerviewinsert', postdata)
    ...
    }, [postdata, setIsModalOpen, setOpenRowIndex, setcount, count])
    return (
        <Box>
...
export default memo(CeoMarkModal)