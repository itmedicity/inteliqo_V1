                ...
                <Table sx={{ mt: 1, p: 0, border: '1px solid #e0e0e0', width: '100%' }}>
                    <TableBody>
                        <TableRow sx={{ p: 0 }}>
                            ...
                            {/* <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography textColor="#000000" sx={{ ml: 1 }}>Ceo  Mark</Typography>
                            </TableCell> */}
                        ...
                        <TableRow sx={{ p: 0 }} >
                            ...
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1, textTransform: 'capitalize' }}>{data?.Dmsmark === undefined ? 0 : data?.Dmsmark} </Typography>
                            </TableCell>
                            <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1, textTransform: 'capitalize' }}>{data?.Operationmark === undefined ? 0 : data?.Operationmark}</Typography>
                            </TableCell>
                            {/* <TableCell padding='none' sx={{ border: '1px solid #e0e0e0' }}>
                                <Typography sx={{ ml: 1, textTransform: 'capitalize' }}>{data?.Ceomark === undefined ? 0 : data?.Ceomark} </Typography>
                            </TableCell> */}
                        </TableRow>
