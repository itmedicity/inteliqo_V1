...
const MsMarkModal = ({ setIsModalOpen, data, setcount, count, setOpenRowIndex, stausdata }) => {
    ...
    const postdata = useMemo(() => {
        ...
        attitudeark, confidencemark, bodylanmark,
    ...
    const submitmanpower = useCallback(async (event) => {
        ...
        const result = await axioslogin.post('/Applicationform/Msinterviewinsert', postdata)
    ...
    }, [postdata, setcount, count, setIsModalOpen, setOpenRowIndex])
    return (
        <Box>
...
export default memo(MsMarkModal)