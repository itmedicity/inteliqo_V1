...
const HodModal = lazy(() => import('./ApprovalViewData/Hod/HodModal'))
...
const Hod = () => {
    ...
    return (
        <Box sx={{ display: 'flex', flex: 1, flexDirection: 'column', height: window.innerHeight - 100, overflowX: "auto" }}>
            <DasboardCustomLayout title={"Interview Hod"} displayClose={true} setClose={toRedirectToHome}>
                                            ...
                                            <Fragment key={val.desg_id}>
                                                ...
                                                {isRowOpen && (
                                                    <TableRow padding='none' sx={{ backgroundColor: "#F8F6F4" }}>
                                                        ...
                                                        <TableCell size='small' padding='normal' ><Typography sx={{ color: "#808B97", }}>Initial Assesment</Typography></TableCell>
