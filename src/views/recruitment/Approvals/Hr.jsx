...
const HrModal = lazy(() => import('./ApprovalViewData/Hr/HrModal'))
...
const Hr = () => {
    ...
    return (
        <Box sx={{ display: 'flex', flex: 1, flexDirection: 'column', height: window.innerHeight - 100, overflowX: "auto" }}>
            <DasboardCustomLayout title={"Interview Hr"} displayClose={true} setClose={toRedirectToHome}>
