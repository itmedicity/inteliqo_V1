...
const MsModal = lazy(() => import('./ApprovalViewData/Ms/MsModal'))
...
const Ms = () => {
    ...
    return (
        <Box sx={{ display: 'flex', flex: 1, flexDirection: 'column', height: window.innerHeight - 100, overflowX: "auto" }}>
            <DasboardCustomLayout title={"Interview Ms"} displayClose={true} setClose={toRedirectToHome}>
