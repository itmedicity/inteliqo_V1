...
const CeoApproval = () => {
    ...
    return (
        <Fragment>
            <Suspense>
                <ApprovalModel open={open} setOpen={setOpen} data={details} loginEmp={em_id} setCount={setCount} slno={3} />
            </Suspense>
            <CustomLayout title="Resignation Approval CEO" displayClose={true} >
                <ToastContainer />
                <Paper sx={{ width: '100%' }}>
