    ...
    return (
        <CustomSettingsLayout title="Training Questions Master" displayClose={true} >
            ...
            <Box sx={{
                ...
                <Paper variant='outlined' sx={{ p: 1, width: "100%", display: "flex", flexDirection: "column" }}>
                    <Box sx={{ display: "flex", flexDirection: "row", gap: 1 }}>
                        <Box sx={{ width: "20%" }}>
                            ...
                            <TrainingTopicsRdx topicValue={training_topic} getTopic={setTraining_topic}
                ...
                {view === 1 ? <FileopenModal Reset={editReset} setUploads={setDisFile} uploads={disFile} view={view} setview={setview} setopen={setopen} open={open} /> : null}
