...
const DepartmentShiftMast = () => {
    ...
    }, [notapplicable_shift, default_shift, week_off_day, arraydata, count,
        dept, deptSect, slno, flag])
                    ...
                    <Box sx={{ width: "100%", px: 1, mt: 0.5, display: 'flex', flexDirection: 'row', }}>
                        <TableContainer sx={{}}>
                            <Table size="small" stickyHeader aria-label="sticky table" sx={{ border: '1px solid #e0e0e0' }}>
                                <TableHead>
                                    <TableRow>
                                        <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550 }} > Shift Code </TableCell>
                                        <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550 }} >Shift Description</TableCell>
