...
const TrainingName = () => {
  ...
  }, [training_name, trainingtype, trainingcategory, training_name_status])
  ...
  }, [training_name, trainingtype, trainingcategory, training_name_status, name_slno])
  ...
  return (
    <MasterLayout title="Training Name Master" displayClose={true}>
      <ToastContainer />
      <Box sx={{ width: '100%' }}>
