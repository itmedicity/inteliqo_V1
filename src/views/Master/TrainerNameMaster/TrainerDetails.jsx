...
const TrainerDetails = () => {
  ...
  return (
    <MasterLayout title="Trainer Name Master" displayClose={true}>
      <ToastContainer />
      <Box sx={{ width: '100%' }}>
          ...
          {view === 1 ? (
            <Box sx={{ display: 'flex', flexDirection: 'row', mt: 1, gap: 1 , ml:0.5}}>
              <Tooltip title="Emp ID ">
                <Box>
                  <JoyInput size="sm" value={Emp_no} name="Employee_No" disabled={true} />
                </Box>
              </Tooltip>
              <Tooltip title="Trainer Name ">
                <Box sx={{ flex: 1 }}>
                  <JoyInput size="sm" value={empSelect} name="Employee_Name" disabled={true} />
                </Box>
              </Tooltip>
              <Tooltip title="Designation ">
                <Box sx={{ flex: 1 }}>
                  <JoyInput size="sm" value={desSelect} name="designation" disabled={true} />
                </Box>
              </Tooltip>
              <Tooltip title="Department ">
                <Box sx={{ flex: 1 }}>
                  <JoyInput size="sm" value={depttype} name="dept_name" disabled={true} />
                </Box>
              </Tooltip>
              <Tooltip title="Department Section">
                <Box sx={{ flex: 1 }}>
                  <JoyInput size="sm" value={deptSec} name="sec_name" disabled={true} />
                </Box>
              </Tooltip>
              <Tooltip title="Save">
                <Box sx={{ px: 0.5 }}>
