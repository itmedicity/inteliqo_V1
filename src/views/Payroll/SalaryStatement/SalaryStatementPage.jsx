...
const SalaryStatementPage = () => {
    ...
    return (
        <CustomLayout title="Salary Statement" displayClose={true} >
                        ...
                        <Table sx={{ backgroundColor: '#F3F6F9' }} size="small" >
                            <TableHead>
                                <TableRow sx={{ color: '#003A75' }} hover >
                                    ...
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Department</TableCell>
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Designation</TableCell>
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Acc/ Number</TableCell>
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Toal</TableCell>
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>LOP</TableCell>
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Calculated LOP</TableCell>
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Earned Days</TableCell>
                                    {
                                    ...
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Gross</TableCell>
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Net Pay</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                <Suspense>
                                    {
                                        empArray?.map((e, idx) => (
                                            <TableRow key={idx} >
                                                ...
                                                <TableCell size='small' padding='none' align="center" sx={{ minHeight: 25, fontWeight: 550 }}>{e.dept_name}</TableCell>
                                                <TableCell size='small' padding='none' align="center" sx={{ minHeight: 25, fontWeight: 550 }}>{e.desg_name}</TableCell>
                                                <TableCell size='small' padding='none' align="center" sx={{ minHeight: 25, fontWeight: 550 }}>{e.em_account_no}</TableCell>
                                                <TableCell size='small' padding='none' align="center" sx={{ minHeight: 25, fontWeight: 550 }}>{e.total_working_days}</TableCell>
                                                <TableCell size='small' padding='none' align="center" sx={{ minHeight: 25, fontWeight: 550 }}>{e.total_lop}</TableCell>
                                                <TableCell size='small' padding='none' align="center" sx={{ minHeight: 25, fontWeight: 550 }}>{e.calculated_lop}</TableCell>
                                                <TableCell size='small' padding='none' align="center" sx={{ minHeight: 25, fontWeight: 550 }}>{e.total_days}</TableCell>
                                                {
                                                ...
                                                <TableCell size='small' padding='none' align="center" sx={{ minHeight: 25, fontWeight: 550 }}>{e.gross_amount}</TableCell>
                                                <TableCell size='small' padding='none' align="center" sx={{ minHeight: 25, fontWeight: 550 }}>{e.net_amount}</TableCell>
                                            </TableRow>
                                        ))
                                    }
                                </Suspense>
