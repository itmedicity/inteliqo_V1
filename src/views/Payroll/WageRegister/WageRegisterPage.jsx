...
const WageRegisterPage = () => {
    ...
    return (
        <CustomLayout title="Wage Register" displayClose={true} >
                        ...
                        <Table sx={{ backgroundColor: '#F3F6F9' }} size="small" >
                            <TableHead>
                                <TableRow sx={{ color: '#003A75' }} hover >
                                    ...
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Father/ Spouse Name</TableCell>
                                    ...
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Total</TableCell>
                                    <TableCell size='medium' padding='none' align="center" rowSpan={2} sx={{ fontWeight: 550, width: 200 }}>Net Paid</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                {
