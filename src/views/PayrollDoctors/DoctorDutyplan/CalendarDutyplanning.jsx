...
const CalendarDutyplanning = () => {
    ...
    }, [dept, section, emply, monthStart, monthEnd, holidayList])
                        ...
                        {weeks?.map((week, weekIndex) => (
                            <Grid container spacing={1} key={weekIndex} sx={{ mt: 0.5 }}>
                                {week?.map((date, dayIndex) => {
                                    ...
                                    const dutyLabel = dutySlno === 0 ? 'NIL' : dutyList?.find(opt => opt?.dutyslno === dutySlno)?.duty_name;
                                        ...
                                        <Grid xs={12 / 7} key={dayIndex}>
                                            <Box
                                                ...
                                                sx={{
                                                    ...
                                                    boxShadow: '0px 4px 6px rgba(201, 201, 201, 0.2), 0px 6px 20px rgba(215, 215, 215, 0.19)',
                                                    height: 80,
                                                    display: 'flex',
